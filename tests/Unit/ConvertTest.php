...
class ConvertTest extends TestCase
{
    ...
    public function test_toArray(): void
    {
        ...
        $this->assertCount(2, $banks['0288']['branches']);
        $this->assertCount(3, $banks['0289']['branches']);

        $this->assertSame('本店営業部', $banks['0288']['branches']['110']['branch_name']);
        $this->assertSame('上野支店', $banks['0288']['branches']['140']['branch_name']);
        $this->assertSame('本店営業部', $banks['0289']['branches']['010']['branch_name']);
        $this->assertSame('大森支店', $banks['0289']['branches']['021']['branch_name']);
        $this->assertSame('渋谷支店', $banks['0289']['branches']['022']['branch_name']);
    }
